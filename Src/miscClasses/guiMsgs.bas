...
Public Sub BuildMainSetup() As Map
	...
	m.Put(cs.Initialize.Append(" ").Typeface(Typeface.MATERIALICONS).VerticalAlign(6dip).Append(Chr(0xE913)). _
				 Typeface(Typeface.DEFAULT).Append("   External Apps").PopAll,"exp")
